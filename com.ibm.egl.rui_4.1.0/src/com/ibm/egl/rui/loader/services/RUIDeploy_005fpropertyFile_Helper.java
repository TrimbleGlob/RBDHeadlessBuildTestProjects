...
public class RUIDeploy_005fpropertyFile_Helper extends com.ibm.javart.util.JavartRecordHelper
{
	private static final long serialVersionUID = 70L;
	
	protected com.ibm.javart.resources.Program ezeProgram;
	private java.util.Properties xmlProps = null;
	public RUIDeploy_005fpropertyFile_Helper( com.ibm.javart.resources.Program ezeProgram )
	{
	...
	public String getJsonFieldName( String fieldName )
	{
		if( jsonNames == null )
		{
			...
			jsonNames.put( "propertyFile", "propertyFile" );
		}
	...
	public String getFormDataFieldName( String fieldName )
	{
		if( formDataNames == null )
		{
			...
			formDataNames.put( "propertyFile", "propertyFile" );
		}
	...
	public java.util.Properties XMLProperties()
	{
		if(xmlProps == null)
		{
			...
			xmlProps.put( "XMLRootElement.name", "RUIDeploy_propertyFile" );
			xmlProps.put( "XMLArray.propertyFile", "" );
			xmlProps.put( "XMLArray.propertyFile.dimension", Integer.valueOf(1) );
			xmlProps.put( "XMLArray.propertyFile.basetype", "string" );
		}
		return xmlProps;
	}
