...
public class RUIDeploy_005fruntimePropertyFile_Helper extends com.ibm.javart.util.JavartRecordHelper
{
	private static final long serialVersionUID = 70L;
	
	protected com.ibm.javart.resources.Program ezeProgram;
	private java.util.Properties xmlProps = null;
	public RUIDeploy_005fruntimePropertyFile_Helper( com.ibm.javart.resources.Program ezeProgram )
	{
	...
	public String getJsonFieldName( String fieldName )
	{
		if( jsonNames == null )
		{
			...
			jsonNames.put( "runtimePropertyFile", "runtimePropertyFile" );
		}
	...
	public String getFormDataFieldName( String fieldName )
	{
		if( formDataNames == null )
		{
			...
			formDataNames.put( "runtimePropertyFile", "runtimePropertyFile" );
		}
	...
	public java.util.Properties XMLProperties()
	{
		if(xmlProps == null)
		{
			...
			xmlProps.put( "XMLRootElement.name", "RUIDeploy_runtimePropertyFile" );
			xmlProps.put( "XMLArray.runtimePropertyFile", "" );
			xmlProps.put( "XMLArray.runtimePropertyFile.dimension", Integer.valueOf(1) );
			xmlProps.put( "XMLArray.runtimePropertyFile.basetype", "string" );
		}
		return xmlProps;
	}
