...
egl.defineRUIWidget('com.ibm.egl.rui.widgets', 'TextLabel', {
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,44,1390,85, this);
			this.text = "";
			egl.atLine(this.eze$$fileName,46,1479,42, this);
			this.widgetOrientationThis = "";
			this.jsrt$SysVar= new egl.egl.core.SysVar();
			egl.atLine(this.eze$$fileName,46,1487,21, this);
			this.widgetOrientationThis = "";
	...
	"setText": function( textIn ) {
		...
		try { egl.enter("setText",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,49,1564,14, this);
			this.text = textIn;
			egl.atLine(this.eze$$fileName,50,1581,17, this);
			this.setInnerText(this.text);
			egl.atLine(this.eze$$fileName,48,1527,76, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getText": function() {
		...
		try { egl.enter("getText",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,54,1645,14, this);
			$result = this.text;
	...
	"getWidgetOrientation": function() {
		...
		try { egl.enter("getWidgetOrientation",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,58,1732,36, this);
	...
	"setWidgetOrientation": function( widgetOrientation ) {
		...
		try { egl.enter("setWidgetOrientation",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,62,1854,47, this);
			this.widgetOrientationThis = widgetOrientation;
			egl.atLine(this.eze$$fileName,63,1905,207, this);
			if ( (widgetOrientation == "RTL") ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,64,1939,34, this);
					this.setStyle("text-align: right;");
					var ezert$$1 = "";
					ezert$$1 = this.getTextLayout();
					egl.atLine(this.eze$$fileName,65,1977,80, this);
					if ( (ezert$$1 != "Visual") ) {
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,66,2018,32, this);
				...
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,69,2071,33, this);
					this.setStyle("text-align: left;");
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,61,1779,338, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
