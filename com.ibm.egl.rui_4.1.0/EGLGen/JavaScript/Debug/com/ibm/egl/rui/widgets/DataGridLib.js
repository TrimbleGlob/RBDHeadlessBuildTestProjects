...
egl.defineRUILibrary( 'com.ibm.egl.rui.widgets', 'DataGridLib',
	{
		...
		"constructor" : function()
		{
			...
			try { egl.enter("<init>",this,arguments,eze$$updater);
				...
				egl.atLine(this.eze$$fileName,26,612,21, this);
				this.util = new egl.com.ibm.egl.rui.widgets.DataGridUtil();
				
				this.jsrt$SysVar= new egl.egl.core.SysVar();
				egl.atLine(this.eze$$fileName,14,343,11, this);
				this.ALIGN_RIGHT = 2;
				egl.atLine(this.eze$$fileName,15,371,10, this);
				this.ALIGN_LEFT = 0;
				egl.atLine(this.eze$$fileName,16,399,12, this);
				this.ALIGN_CENTER = 1;
				egl.atLine(this.eze$$fileName,18,430,17, this);
				this.DISABLE_SELECTION = 0;
				egl.atLine(this.eze$$fileName,19,464,16, this);
				this.SINGLE_SELECTION = 1;
				egl.atLine(this.eze$$fileName,20,497,18, this);
				this.MULTIPLE_SELECTION = 2;
				egl.atLine(this.eze$$fileName,22,534,9, this);
				this.SORT_NONE = 0;
				egl.atLine(this.eze$$fileName,23,563,9, this);
				this.SORT_DOWN = 1;
				egl.atLine(this.eze$$fileName,24,592,7, this);
				this.SORT_UP = 2;
				if (!egl.debugg) egl.leave();
			} finally {
				if (!egl.debugg){
