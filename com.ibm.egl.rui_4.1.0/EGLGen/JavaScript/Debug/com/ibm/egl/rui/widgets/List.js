...
egl.defineRUIWidget('com.ibm.egl.rui.widgets', 'List', {
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,25,641,93, this);
			this.values = (function(){ var ezert$$1= []; ezert$$1.setType( "S;" );// no max size set for this array
			return ezert$$1;})();
			
			egl.atLine(this.eze$$fileName,26,736,97, this);
			this.selection = 0;
			egl.atLine(this.eze$$fileName,31,909,82, this);
			this.size = 0;
			egl.atLine(this.eze$$fileName,33,995,26, this);
			...
			egl.atLine(this.eze$$fileName,34,1023,32, this);
			this.sizeSet = false;
			egl.atLine(this.eze$$fileName,35,1057,47, this);
			this.reverseTextDirectionThis = "";
			egl.atLine(this.eze$$fileName,36,1106,42, this);
			this.textLayoutThis = "";
			this.jsrt$SysVar= new egl.egl.core.SysVar();
			new egl.com.ibm.egl.rui.widgets.UtilLib();
			egl.atLine(this.eze$$fileName,34,1031,7, this);
			this.sizeSet = false;
			egl.atLine(this.eze$$fileName,35,1065,24, this);
			this.reverseTextDirectionThis = "No";
			egl.atLine(this.eze$$fileName,36,1114,14, this);
	...
	"setValues": function( value ) {
		...
		try { egl.enter("setValues",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,39,1194,15, this);
			this.values = value;
			egl.atLine(this.eze$$fileName,40,1212,17, this);
			this.removeChildren();
			egl.atLine(this.eze$$fileName,41,1232,82, this);
			{
				try{egl.enterBlock();
					var i = 0;
					...
					for ( ; (i <= this.options.getSize()); i = (i + 1) )
					{
						egl.setLocalFunctionVariable("i", i, "int");
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,42,1274,34, this);
			...
			egl.atLine(this.eze$$fileName,44,1317,20, this);
			this.options.removeAll();
			egl.atLine(this.eze$$fileName,45,1340,196, this);
			{
				try{egl.enterBlock();
					var index = 0;
					...
					for ( ; (index <= value.getSize()); index = (index + 1) )
					{
						...
						try{egl.enterBlock();
							...
							egl.atLine(this.eze$$fileName,46,1416,18, this);
							option.setTagName( "option" );
							egl.atLine(this.eze$$fileName,47,1440,32, this);
							option.setInnerHTML( egl.checkNull(value, "value")[value.checkIndex((index)-1)] );
							egl.atLine(this.eze$$fileName,48,1476,30, this);
							this.options.appendElement( option );
							egl.atLine(this.eze$$fileName,49,1510,20, this);
			...
			egl.atLine(this.eze$$fileName,51,1539,16, this);
			this.setSelection(1 );
			egl.atLine(this.eze$$fileName,52,1560,49, this);
			if ( !(this.sizeSet) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,53,1585,16, this);
					var ezert$$3 = 0;
					ezert$$3 = this.values.getSize();
					egl.atLine(this.eze$$fileName,53,1577,26, this);
					this.setSize(ezert$$3 );
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,55,1612,106, this);
			if ( ((this.textLayoutThis == "Visual") || (this.reverseTextDirectionThis == "Yes")) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,56,1695,17, this);
					this.setBiDiMarkers();
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,38,1154,571, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getValues": function() {
		...
		try { egl.enter("getValues",this,arguments,eze$$updater);
			var $result = null;
			egl.atLine(this.eze$$fileName,61,1771,16, this);
			$result = this.values;
	...
	"setSelection": function( selection ) {
		...
		try { egl.enter("setSelection",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,65,1842,47, this);
			if ( (selection > 0) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,65,1872,17, this);
					var ezert$$4 = 0;
			...
			egl.atLine(this.eze$$fileName,65,1838,107, this);
			if ( eze_Cond_Temp_0 ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,66,1894,45, this);
			...
			egl.atLine(this.eze$$fileName,64,1796,154, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getSelection": function() {
		...
		try { egl.enter("getSelection",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,71,1994,53, this);
			var ezert$$6 = null;
			ezert$$6 = ezert$$5;
	...
	"setSize": function( sizeIn ) {
		...
		try { egl.enter("setSize",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,75,2090,91, this);
			if ( (sizeIn > 1) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,76,2109,14, this);
					this.size = sizeIn;
					egl.atLine(this.eze$$fileName,77,2127,15, this);
					this.sizeSet = true;
					egl.atLine(this.eze$$fileName,78,2146,29, this);
					this.setAttribute("size", {eze$$value : sizeIn, eze$$signature : "I;"} );
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,74,2056,130, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getSize": function() {
		...
		try { egl.enter("getSize",this,arguments,eze$$updater);
			var $result = 0;
			egl.atLine(this.eze$$fileName,83,2225,14, this);
			$result = this.size;
			egl.setLocalFunctionVariable("INT", $result, "int");
			{ if (!egl.debugg) egl.leave(); return $result;}
		} finally {
	...
	"setTextLayout": function( textLayout ) {
		...
		try { egl.enter("setTextLayout",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,87,2309,33, this);
			this.textLayoutThis = textLayout;
			egl.atLine(this.eze$$fileName,88,2346,17, this);
			this.setBiDiMarkers();
			egl.atLine(this.eze$$fileName,86,2248,120, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getTextLayout": function() {
		...
		try { egl.enter("getTextLayout",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,92,2430,29, this);
	...
	"setReverseTextDirection": function( reverseTextDirection ) {
		...
		try { egl.enter("setReverseTextDirection",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,96,2548,53, this);
			this.reverseTextDirectionThis = reverseTextDirection;
			egl.atLine(this.eze$$fileName,97,2607,17, this);
			this.setBiDiMarkers();
			egl.atLine(this.eze$$fileName,95,2467,162, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getReverseTextDirection": function() {
		...
		try { egl.enter("getReverseTextDirection",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,101,2701,39, this);
	...
	"setBiDiMarkers": function() {
		...
		try { egl.enter("setBiDiMarkers",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,105,2786,8, this);
			...
			egl.atLine(this.eze$$fileName,106,2840,18, this);
			...
			egl.atLine(this.eze$$fileName,107,2913,119, this);
			{
				try{egl.enterBlock();
					var index = 0;
					egl.addLocalFunctionVariable("index", index, "int", "index");
					...
					for ( ; (index <= this.options.getSize()); index = (index + 1) )
					{
						egl.setLocalFunctionVariable("index", index, "int");
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,108,2967,59, this);
			...
			egl.atLine(this.eze$$fileName,104,2750,287, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setValueAsText": function( selectionText ) {
		...
		try { egl.enter("setValueAsText",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,113,3101,134, this);
			{
				try{egl.enterBlock();
					var index = 0;
					egl.addLocalFunctionVariable("index", index, "int", "index");
					...
					for ( ; (index <= this.values.getSize()); index = (index + 1) )
					{
						egl.setLocalFunctionVariable("index", index, "int");
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,114,3151,78, this);
							if ( (selectionText == egl.checkNull(this.values, "values")[this.values.checkIndex((index)-1)]) ) {
								try{egl.enterBlock();
									egl.atLine(this.eze$$fileName,115,3190,20, this);
									this.setSelection(index );
									egl.atLine(this.eze$$fileName,116,3215,7, this);
			...
			egl.atLine(this.eze$$fileName,119,3241,16, this);
			var ezert$$7 = 0;
			ezert$$7 = this.values.getSize();
			egl.atLine(this.eze$$fileName,119,3238,50, this);
			if ( (ezert$$7 > 0) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,120,3266,16, this);
					this.setSelection(1 );
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,112,3042,251, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getValueAsText": function() {
		...
		try { egl.enter("getValueAsText",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,125,3365,14, this);
			var ezert$$8 = 0;
			ezert$$8 = this.getSelection();
			egl.atLine(this.eze$$fileName,125,3350,32, this);
			var ezert$$9 = 0;
			ezert$$9 = ezert$$8;
