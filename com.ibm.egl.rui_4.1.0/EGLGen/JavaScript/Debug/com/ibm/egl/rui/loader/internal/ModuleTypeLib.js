...
egl.defineRUILibrary( 'com.ibm.egl.rui.loader.internal', 'ModuleTypeLib',
	{
		...
		"constructor" : function()
		{
			...
			try { egl.enter("<init>",this,arguments,eze$$updater);
				...
				egl.atLine(this.eze$$fileName,5,109,3, this);
				this.css = "cssFile";
				egl.atLine(this.eze$$fileName,6,140,8, this);
				this.property = "propertyFile";
				egl.atLine(this.eze$$fileName,7,181,7, this);
				this.imports = "importFile";
				egl.atLine(this.eze$$fileName,8,219,15, this);
				this.runtimeProperty = "runtimePropertyFile";
				egl.atLine(this.eze$$fileName,9,274,7, this);
