...
egl.defineClass('com.ibm.egl.rui.widgets', 'MenuItemAction', {
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,13,327,28, this);
			this.theAction = null;
			
			egl.atLine(this.eze$$fileName,14,357,12, this);
			this.theItem = null;
			egl.atLine(this.eze$$fileName,15,371,19, this);
	...
	"addActionTo": function( widget ) {
		...
		try { egl.enter("addActionTo",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,18,432,9, this);
			...
			egl.atLine(this.eze$$fileName,19,461,32, this);
			...
			egl.atLine(this.eze$$fileName,17,394,104, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
