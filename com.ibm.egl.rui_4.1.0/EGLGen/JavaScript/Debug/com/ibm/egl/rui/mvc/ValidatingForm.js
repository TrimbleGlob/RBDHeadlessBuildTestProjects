...
egl.defineRUIWidget('com.ibm.egl.rui.mvc', 'ValidatingForm', {
	...
	"setEntries": function( entries ) {
		...
		try { egl.enter("setEntries",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,29,732,23, this);
			this.entries = entries;
			egl.atLine(this.eze$$fileName,30,758,575, this);
			{
				try{egl.enterBlock();
					var n = 0;
					...
					for ( ; (n <= entries.getSize()); n = (n + 1) )
					{
						egl.setLocalFunctionVariable("n", n, "int");
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,31,806,74, this);
							egl.checkNull(this.entries, "entries")[this.entries.checkIndex((n)-1)].nameLabel = (function () {
								...
								egl.atLine(this.eze$$fileName,31,850,27, this);
							...
							egl.atLine(this.eze$$fileName,32,884,56, this);
							...
							egl.atLine(this.eze$$fileName,35,1044,100, this);
							...
							if ( (egl.checkNull(egl.checkNull(this.entries, "entries")[this.entries.checkIndex((n)-1)].controller, "entries[n].controller").validStateSetter == null) ) {
								try{egl.enterBlock();
									egl.atLine(this.eze$$fileName,38,1257,63, this);
			...
			egl.atLine(this.eze$$fileName,41,1336,17, this);
			this.appendChild(this.box );
			egl.atLine(this.eze$$fileName,28,686,672, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getEntries": function() {
		...
		try { egl.enter("getEntries",this,arguments,eze$$updater);
			var $result = null;
			egl.atLine(this.eze$$fileName,45,1407,17, this);
			$result = this.entries;
	...
	"commit": function() {
		...
		try { egl.enter("commit",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,49,1455,233, this);
			{
				try{egl.enterBlock();
					var n = 0;
					egl.addLocalFunctionVariable("n", n, "int", "n");
					...
					for ( ; (n >= 1); n = (n - 1) )
					{
						egl.setLocalFunctionVariable("n", n, "int");
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,50,1513,31, this);
							...
							egl.atLine(this.eze$$fileName,51,1561,39, this);
							var ezert$$5 = null;
							...
							egl.atLine(this.eze$$fileName,51,1548,3, this);
							msg = (function(x){ return x !== null ? ((x).toString()) : ""; })(ezert$$5);
							egl.setLocalFunctionVariable("msg", msg, "string");
							egl.atLine(this.eze$$fileName,52,1605,77, this);
							if ( !(((msg == null) || (msg == ""))) ) {
								try{egl.enterBlock();
									egl.atLine(this.eze$$fileName,53,1642,33, this);
			...
			egl.atLine(this.eze$$fileName,48,1435,258, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"publish": function() {
		...
		try { egl.enter("publish",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,59,1718,96, this);
			{
				try{egl.enterBlock();
					var n = 0;
					egl.addLocalFunctionVariable("n", n, "int", "n");
					...
					for ( ; (n >= 1); n = (n - 1) )
					{
						egl.setLocalFunctionVariable("n", n, "int");
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,60,1776,32, this);
			...
			egl.atLine(this.eze$$fileName,58,1697,125, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"isValid": function() {
		...
		try { egl.enter("isValid",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,65,1864,6, this);
			result = true;
			egl.setLocalFunctionVariable("result", result, "boolean");
			egl.atLine(this.eze$$fileName,66,1889,132, this);
			{
				try{egl.enterBlock();
					var n = 0;
					egl.addLocalFunctionVariable("n", n, "int", "n");
			...
			egl.atLine(this.eze$$fileName,71,2026,15, this);
			$result = result;
	...
	"validStateSetter": function( view, valid ) {
		...
		try { egl.enter("validStateSetter",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,75,2112,216, this);
			{
				try{egl.enterBlock();
					var n = 0;
					egl.addLocalFunctionVariable("n", n, "int", "n");
					...
					for ( ; (n >= 1); n = (n - 1) )
					{
						...
						try{egl.enterBlock();
							...
							egl.atLine(this.eze$$fileName,76,2170,5, this);
							...
							var msg = null;
							egl.addLocalFunctionVariable("msg", msg, "string?", "msg");
							egl.atLine(this.eze$$fileName,77,2217,34, this);
							var ezert$$9 = null;
							ezert$$9 = egl.checkNull(entry.controller, "entry.controller").getErrorMessage();
							egl.atLine(this.eze$$fileName,77,2203,3, this);
							msg = ezert$$9;
							egl.setLocalFunctionVariable("msg", msg, "string?");
							egl.atLine(this.eze$$fileName,78,2256,28, this);
							egl.checkNull(entry.errorLabel, "entry.errorLabel").setText((function(x){ return x !== null ? ((x).toString()) : ""; })(msg));
							egl.atLine(this.eze$$fileName,79,2288,34, this);
			...
			egl.atLine(this.eze$$fileName,74,2050,283, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setValidState": function( entry, eze$$entry$func_, view, valid, eze$$caller ) {
		...
		try { egl.enter("setValidState",this,arguments,eze$$updater);
			...
			egl.addLocalFunctionVariable("view", view, "egl.ui.rui.Widget", "view");
			egl.addLocalFunctionVariable("valid", valid, "boolean", "valid");
			egl.atLine(this.eze$$fileName,84,2413,181, this);
			if ( (egl.checkNull(entry.controller, "entry.controller").getView() == view) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,85,2451,137, this);
					if ( valid ) {
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,86,2466,41, this);
							egl.checkNull(entry.nameLabel, "entry.nameLabel").setClass((function(x){ return x !== null ? ((x).toString()) : ""; })(entry.labelClass));
						}finally{egl.exitBlock();}
					}
					else {
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,88,2520,61, this);
			...
			egl.atLine(this.eze$$fileName,83,2337,262, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
