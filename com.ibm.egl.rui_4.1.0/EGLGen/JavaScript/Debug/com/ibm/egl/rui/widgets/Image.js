...
egl.defineRUIWidget('com.ibm.egl.rui.widgets', 'Image', {
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,19,498,85, this);
			this.text = "";
			egl.atLine(this.eze$$fileName,20,585,82, this);
			this.src = "";
	...
	"getText": function() {
		...
		try { egl.enter("getText",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,23,709,14, this);
			$result = this.text;
	...
	"setText": function( textIn ) {
		...
		try { egl.enter("setText",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,27,769,14, this);
			this.text = textIn;
			egl.atLine(this.eze$$fileName,28,786,26, this);
			this.setAttribute("alt", {eze$$value : this.text, eze$$signature : "S;"} );
			egl.atLine(this.eze$$fileName,26,732,85, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getSrc": function() {
		...
		try { egl.enter("getSrc",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,32,858,13, this);
			$result = this.src;
			egl.setLocalFunctionVariable("STRING", $result, "string");
			{ if (!egl.debugg) egl.leave(); return $result;}
		} finally {
	...
	"setSrc": function( srcIn ) {
		...
		try { egl.enter("setSrc",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,36,915,12, this);
			this.src = srcIn;
			egl.atLine(this.eze$$fileName,37,930,25, this);
			this.setAttribute("src", {eze$$value : this.src, eze$$signature : "S;"} );
			egl.atLine(this.eze$$fileName,35,880,80, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setWidth": function( w ) {
		...
		try { egl.enter("setWidth",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,41,1007,25, this);
			this.setAttribute("width", {eze$$value : w, eze$$signature : "I;"} );
			egl.atLine(this.eze$$fileName,40,963,74, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setHeight": function( h ) {
		...
		try { egl.enter("setHeight",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,45,1085,26, this);
			this.setAttribute("height", {eze$$value : h, eze$$signature : "I;"} );
			egl.atLine(this.eze$$fileName,44,1040,76, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
