...
egl.defineRUILibrary( 'com.ibm.egl.rui.mvc', 'MVCLib',
	{
		...
		"constructor" : function()
		{
			...
			try { egl.enter("<init>",this,arguments,eze$$updater);
				...
				egl.atLine(this.eze$$fileName,5,68,44, this);
				this.currentController = null;
				
				this.jsrt$SysVar= new egl.egl.core.SysVar();
				egl.atLine(this.eze$$fileName,5,76,17, this);
				this.currentController = null;
				if (!egl.debugg) egl.leave();
			} finally {
				if (!egl.debugg){
		...
		"getCurrentContext": function() {
			...
			try { egl.enter("getCurrentContext",this,arguments,eze$$updater);
				var $result = null;
				egl.atLine(this.eze$$fileName,8,166,26, this);
		...
		"setCurrentContext": function( acontroller ) {
			...
			try { egl.enter("setCurrentContext",this,arguments,eze$$updater);
				...
				egl.atLine(this.eze$$fileName,12,257,37, this);
				this.currentController = acontroller;
				egl.atLine(this.eze$$fileName,11,201,98, this);
				{ if (!egl.debugg) egl.leave(); }
			} finally {
				if (!egl.debugg){
				} else { egl.leave(); }
