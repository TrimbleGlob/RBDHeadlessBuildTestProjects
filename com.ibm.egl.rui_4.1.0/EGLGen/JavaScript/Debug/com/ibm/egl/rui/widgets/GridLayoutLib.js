...
egl.defineRUILibrary( 'com.ibm.egl.rui.widgets', 'GridLayoutLib',
	{
		...
		"constructor" : function()
		{
			...
			try { egl.enter("<init>",this,arguments,eze$$updater);
				...
				egl.atLine(this.eze$$fileName,14,350,10, this);
				this.ALIGN_LEFT = 0;
				egl.atLine(this.eze$$fileName,15,378,12, this);
				this.ALIGN_CENTER = 1;
				egl.atLine(this.eze$$fileName,16,407,11, this);
				this.ALIGN_RIGHT = 2;
				egl.atLine(this.eze$$fileName,18,436,10, this);
				this.VALIGN_TOP = 3;
				egl.atLine(this.eze$$fileName,19,464,13, this);
				this.VALIGN_MIDDLE = 4;
				egl.atLine(this.eze$$fileName,20,494,13, this);
