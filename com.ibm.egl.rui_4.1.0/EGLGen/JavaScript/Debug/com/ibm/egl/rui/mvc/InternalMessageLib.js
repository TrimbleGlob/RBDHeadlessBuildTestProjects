...
egl.defineRUILibrary( 'com.ibm.egl.rui.mvc', 'InternalMessageLib',
	{
		...
		"getRuntimeErrorMessage": function( msgKey, defaultMsgId, inserts ) {
			...
			try { egl.enter("getRuntimeErrorMessage",this,arguments,eze$$updater);
				...
				egl.atLine(this.eze$$fileName,16,497,145, this);
				if ( (msgKey == "") ) {
					try{egl.enterBlock();
						egl.atLine(this.eze$$fileName,17,541,40, this);
						var ezert$$1 = null;
						ezert$$1 = egl.getRuntimeMessage( defaultMsgId, inserts );
						egl.atLine(this.eze$$fileName,17,526,56, this);
					...
					try{egl.enterBlock();
						egl.atLine(this.eze$$fileName,19,608,22, this);
						messageValue = msgKey;
						egl.setLocalFunctionVariable("messageValue", messageValue, "string");
					}finally{egl.exitBlock();}
				}
				egl.atLine(this.eze$$fileName,21,651,21, this);
				$result = messageValue;
