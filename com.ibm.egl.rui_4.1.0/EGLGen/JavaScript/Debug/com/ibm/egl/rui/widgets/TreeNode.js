...
egl.defineRUIWidget('com.ibm.egl.rui.widgets', 'TreeNode', {
	...
	"setImageURL": function( imageURL ) {
		...
		try { egl.enter("setImageURL",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,41,1209,21, this);
			egl.checkNull(this.image, "image").setSrc(imageURL);
			egl.atLine(this.eze$$fileName,42,1233,17, this);
			egl.checkNull(this.image, "image").setWidth((16).toString());
			egl.atLine(this.eze$$fileName,43,1253,18, this);
			egl.checkNull(this.image, "image").setHeight((16).toString());
			egl.atLine(this.eze$$fileName,40,1165,111, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setChildren": function( newChildren ) {
		...
		try { egl.enter("setChildren",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,47,1337,21, this);
			this.ignoreChanges = true;
			egl.atLine(this.eze$$fileName,48,1361,17, this);
			this.removeChildren();
			var childrenCount = 0;
			egl.addLocalFunctionVariable("childrenCount", childrenCount, "int", "childrenCount");
			egl.atLine(this.eze$$fileName,49,1401,21, this);
			var ezert$$1 = 0;
			ezert$$1 = newChildren.getSize();
			egl.atLine(this.eze$$fileName,49,1381,13, this);
			childrenCount = ezert$$1;
			egl.setLocalFunctionVariable("childrenCount", childrenCount, "int");
			egl.atLine(this.eze$$fileName,50,1426,114, this);
			{
				try{egl.enterBlock();
					var n = 0;
					...
					for ( ; (n <= childrenCount); n = (n + 1) )
					{
						...
						try{egl.enterBlock();
							...
							egl.atLine(this.eze$$fileName,51,1470,5, this);
							...
							egl.atLine(this.eze$$fileName,52,1506,28, this);
			...
			egl.atLine(this.eze$$fileName,54,1543,22, this);
			this.ignoreChanges = false;
			egl.atLine(this.eze$$fileName,55,1568,18, this);
			this.childrenChanged();
			egl.atLine(this.eze$$fileName,46,1280,311, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getChildren": function() {
		...
		try { egl.enter("getChildren",this,arguments,eze$$updater);
			var $result = null;
			egl.atLine(this.eze$$fileName,59,1647,20, this);
	...
	"removeChildren": function() {
		...
		try { egl.enter("removeChildren",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,63,1716,23, this);
			this.childNodes.removeAll();
			egl.atLine(this.eze$$fileName,64,1742,35, this);
			egl.checkNull(this.childrenContainer, "childrenContainer").removeChildren();
			egl.atLine(this.eze$$fileName,65,1780,18, this);
			this.childrenChanged();
			egl.atLine(this.eze$$fileName,62,1676,127, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"appendChild": function( child ) {
		...
		try { egl.enter("appendChild",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,69,1856,37, this);
			...
			egl.atLine(this.eze$$fileName,70,1896,4, this);
			...
			egl.atLine(this.eze$$fileName,71,1921,20, this);
			...
			egl.atLine(this.eze$$fileName,72,1944,26, this);
			egl.checkNull(node, "node").setLogicalParent(  this );
			egl.atLine(this.eze$$fileName,73,1973,18, this);
			this.childrenChanged();
			egl.atLine(this.eze$$fileName,68,1807,189, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"childrenChanged": function() {
		...
		try { egl.enter("childrenChanged",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,77,2041,56, this);
			if ( !(this.ignoreChanges) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,78,2064,27, this);
					this.applyBehaviorsToChildren();
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,76,2000,102, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getText": function() {
		...
		try { egl.enter("getText",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,83,2143,43, this);
			if ( (this.span == null) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,83,2161,21, this);
					$result = "span=null";
					egl.setLocalFunctionVariable("STRING", $result, "string");
					{ if (!egl.debugg) egl.leave(); return $result;}
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,84,2189,24, this);
	...
	"setText": function( text ) {
		...
		try { egl.enter("setText",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,87,2255,22, this);
			egl.checkNull(this.span, "span").setInnerHTML(text);
			egl.atLine(this.eze$$fileName,86,2220,62, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"applyBehaviors": function( behaviors, eze$$behaviors$func_, bgColor, eze$$caller ) {
		...
		try { egl.enter("applyBehaviors",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,91,2361,23, this);
			this.bgColor = bgColor;
			egl.atLine(this.eze$$fileName,92,2391,24, this);
			var ezert$$2 = 0;
			ezert$$2 = this.behaviors.getSize();
			egl.atLine(this.eze$$fileName,92,2387,199, this);
			if ( (ezert$$2 == 0) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,93,2425,36, this);
					this.behaviors.appendAll( behaviors );
					var behaviorCount = 0;
					egl.addLocalFunctionVariable("behaviorCount", behaviorCount, "int", "behaviorCount");
					egl.atLine(this.eze$$fileName,94,2485,19, this);
					var ezert$$3 = 0;
					ezert$$3 = behaviors.getSize();
					egl.atLine(this.eze$$fileName,94,2465,13, this);
					behaviorCount = ezert$$3;
					egl.setLocalFunctionVariable("behaviorCount", behaviorCount, "int");
					egl.atLine(this.eze$$fileName,95,2509,71, this);
					{
						try{egl.enterBlock();
							var n = 0;
							egl.addLocalFunctionVariable("n", n, "int", "n");
							...
							for ( ; (n <= behaviorCount); n = (n + 1) )
							{
								egl.setLocalFunctionVariable("n", n, "int");
								try{egl.enterBlock();
									egl.atLine(this.eze$$fileName,96,2554,19, this);
			...
			egl.atLine(this.eze$$fileName,99,2589,27, this);
			this.applyBehaviorsToChildren();
			egl.atLine(this.eze$$fileName,90,2286,335, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"applyBehaviorsToChildren": function() {
		...
		try { egl.enter("applyBehaviorsToChildren",this,arguments,eze$$updater);
			var childrenCount = 0;
			egl.addLocalFunctionVariable("childrenCount", childrenCount, "int", "childrenCount");
			egl.atLine(this.eze$$fileName,103,2683,20, this);
			var ezert$$4 = 0;
			ezert$$4 = this.childNodes.getSize();
			egl.atLine(this.eze$$fileName,103,2663,13, this);
			childrenCount = ezert$$4;
			egl.setLocalFunctionVariable("childrenCount", childrenCount, "int");
			egl.atLine(this.eze$$fileName,104,2707,175, this);
			{
				try{egl.enterBlock();
					var n = 0;
					egl.addLocalFunctionVariable("n", n, "int", "n");
					...
					for ( ; (n <= childrenCount); n = (n + 1) )
					{
						...
						try{egl.enterBlock();
							var child = null;
							egl.addLocalFunctionVariable("child", child, "com.ibm.egl.rui.widgets.TreeNode", "child");
							egl.atLine(this.eze$$fileName,105,2751,5, this);
			...
			egl.atLine(this.eze$$fileName,102,2625,262, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"markAsLast": function( lastNode, bgColor ) {
		...
		try { egl.enter("markAsLast",this,arguments,eze$$updater);
			...
			egl.addLocalFunctionVariable("bgColor", bgColor, "string", "bgColor");
			egl.atLine(this.eze$$fileName,112,2953,178, this);
			if ( lastNode ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,113,2970,76, this);
					egl.checkNull(this.nodeContainer, "nodeContainer").setBackground((bgColor + " url(images/TreeNodeL.gif) no-repeat"));
				}finally{egl.exitBlock();}
			}
			else {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,115,3057,67, this);
					egl.checkNull(this.nodeContainer, "nodeContainer").setBackground(" url(images/TreeNodeL.gif) no-repeat");
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,111,2891,245, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setBiDiStyle": function( textLayoutThis, reverseTextDirectionThis ) {
		...
		try { egl.enter("setBiDiStyle",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,120,3225,38, this);
			egl.checkNull(this.span, "span").setTextLayout(textLayoutThis);
			egl.atLine(this.eze$$fileName,121,3266,58, this);
			egl.checkNull(this.span, "span").setReverseTextDirection(reverseTextDirectionThis);
			egl.atLine(this.eze$$fileName,122,3327,154, this);
			{
				try{egl.enterBlock();
					var i = 0;
					...
					for ( ; (i <= this.childNodes.getSize()); i = (i + 1) )
					{
						...
						try{egl.enterBlock();
							var child = null;
							egl.addLocalFunctionVariable("child", child, "com.ibm.egl.rui.widgets.TreeNode", "child");
							egl.atLine(this.eze$$fileName,123,3378,5, this);
							...
							egl.setLocalFunctionVariable("child", child, "com.ibm.egl.rui.widgets.TreeNode");
							egl.atLine(this.eze$$fileName,124,3415,60, this);
			...
			egl.atLine(this.eze$$fileName,119,3140,348, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
