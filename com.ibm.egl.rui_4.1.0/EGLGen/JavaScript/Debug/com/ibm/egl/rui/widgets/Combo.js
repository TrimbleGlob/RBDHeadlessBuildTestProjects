...
egl.defineRUIWidget('com.ibm.egl.rui.widgets', 'Combo', {
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,37,1013,93, this);
			this.values = (function(){ var ezert$$1= []; ezert$$1.setType( "S;" );// no max size set for this array
			return ezert$$1;})();
			
			egl.atLine(this.eze$$fileName,38,1108,97, this);
			this.selection = 0;
			egl.atLine(this.eze$$fileName,39,1207,47, this);
			this.reverseTextDirectionThis = "";
			egl.atLine(this.eze$$fileName,40,1256,42, this);
			this.textLayoutThis = "";
			egl.atLine(this.eze$$fileName,42,1302,26, this);
			...
			egl.atLine(this.eze$$fileName,39,1215,24, this);
			this.reverseTextDirectionThis = "No";
			egl.atLine(this.eze$$fileName,40,1264,14, this);
	...
	"setValues": function( value ) {
		...
		try { egl.enter("setValues",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,45,1372,15, this);
			this.values = value;
			egl.atLine(this.eze$$fileName,46,1390,17, this);
			this.removeChildren();
			egl.atLine(this.eze$$fileName,47,1410,82, this);
			{
				try{egl.enterBlock();
					var i = 0;
					...
					for ( ; (i <= this.options.getSize()); i = (i + 1) )
					{
						egl.setLocalFunctionVariable("i", i, "int");
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,48,1452,34, this);
			...
			egl.atLine(this.eze$$fileName,50,1495,20, this);
			this.options.removeAll();
			egl.atLine(this.eze$$fileName,51,1518,196, this);
			{
				try{egl.enterBlock();
					var index = 0;
					...
					for ( ; (index <= value.getSize()); index = (index + 1) )
					{
						...
						try{egl.enterBlock();
							...
							egl.atLine(this.eze$$fileName,52,1594,18, this);
							option.setTagName( "option" );
							egl.atLine(this.eze$$fileName,53,1618,32, this);
							option.setInnerHTML( egl.checkNull(value, "value")[value.checkIndex((index)-1)] );
							egl.atLine(this.eze$$fileName,54,1654,30, this);
							this.options.appendElement( option );
							egl.atLine(this.eze$$fileName,55,1688,20, this);
			...
			egl.atLine(this.eze$$fileName,57,1717,16, this);
			this.setSelection(1 );
			egl.atLine(this.eze$$fileName,59,1737,106, this);
			if ( ((this.textLayoutThis == "Visual") || (this.reverseTextDirectionThis == "Yes")) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,60,1820,17, this);
					this.setBiDiMarkers();
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,63,1852,26, this);
			var ezert$$3 = false;
			ezert$$3 = (function () {
				var ezert$$4 = new egl.com.ibm.egl.rui.history.HistoryHelper();
				return ezert$$4;
			}).call(this).isIE();
			egl.atLine(this.eze$$fileName,63,1847,110, this);
			if ( (ezert$$3 && egl.isa(this.getLogicalParent(), "Tcom/ibm/egl/rui/widgets/box;")) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,64,1914,37, this);
					egl.checkNull(this.getLogicalParent(), "logicalParent as Box").layout();
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,44,1332,630, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getValues": function() {
		...
		try { egl.enter("getValues",this,arguments,eze$$updater);
			var $result = null;
			egl.atLine(this.eze$$fileName,69,2008,16, this);
			$result = this.values;
	...
	"setSelection": function( selection ) {
		...
		try { egl.enter("setSelection",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,73,2079,47, this);
			if ( (selection > 0) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,73,2109,17, this);
					var ezert$$5 = 0;
			...
			egl.atLine(this.eze$$fileName,73,2075,114, this);
			if ( eze_Cond_Temp_0 ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,74,2131,52, this);
					egl.checkNull(this.options, "options")[this.options.checkIndex((selection)-1)].setAttribute("selected", "true" );
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,72,2033,161, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getSelection": function() {
		...
		try { egl.enter("getSelection",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,79,2238,52, this);
			var ezert$$7 = null;
			ezert$$7 = ezert$$6;
	...
	"setTextLayout": function( textLayout ) {
		...
		try { egl.enter("setTextLayout",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,83,2360,33, this);
			this.textLayoutThis = textLayout;
			egl.atLine(this.eze$$fileName,84,2397,17, this);
			this.setBiDiMarkers();
			egl.atLine(this.eze$$fileName,82,2299,120, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getTextLayout": function() {
		...
		try { egl.enter("getTextLayout",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,88,2481,29, this);
	...
	"setReverseTextDirection": function( reverseTextDirection ) {
		...
		try { egl.enter("setReverseTextDirection",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,92,2599,53, this);
			this.reverseTextDirectionThis = reverseTextDirection;
			egl.atLine(this.eze$$fileName,93,2658,17, this);
			this.setBiDiMarkers();
			egl.atLine(this.eze$$fileName,91,2518,162, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getReverseTextDirection": function() {
		...
		try { egl.enter("getReverseTextDirection",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,97,2752,39, this);
	...
	"setBiDiMarkers": function() {
		...
		try { egl.enter("setBiDiMarkers",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,101,2837,8, this);
			...
			egl.atLine(this.eze$$fileName,102,2891,18, this);
			...
			egl.atLine(this.eze$$fileName,103,2964,119, this);
			{
				try{egl.enterBlock();
					var index = 0;
					egl.addLocalFunctionVariable("index", index, "int", "index");
					...
					for ( ; (index <= this.options.getSize()); index = (index + 1) )
					{
						egl.setLocalFunctionVariable("index", index, "int");
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,104,3018,59, this);
			...
			egl.atLine(this.eze$$fileName,100,2801,287, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setValueAsText": function( value ) {
		...
		try { egl.enter("setValueAsText",this,arguments,eze$$updater);
			egl.addLocalFunctionVariable("value", value, "string", "value");
			egl.atLine(this.eze$$fileName,109,3144,126, this);
			{
				try{egl.enterBlock();
					var index = 0;
					egl.addLocalFunctionVariable("index", index, "int", "index");
					...
					for ( ; (index <= this.values.getSize()); index = (index + 1) )
					{
						egl.setLocalFunctionVariable("index", index, "int");
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,110,3194,70, this);
							if ( (value == egl.checkNull(this.values, "values")[this.values.checkIndex((index)-1)]) ) {
								try{egl.enterBlock();
									egl.atLine(this.eze$$fileName,111,3225,20, this);
									this.setSelection(index );
									egl.atLine(this.eze$$fileName,112,3250,7, this);
			...
			egl.atLine(this.eze$$fileName,115,3276,16, this);
			var ezert$$8 = 0;
			ezert$$8 = this.values.getSize();
			egl.atLine(this.eze$$fileName,115,3273,49, this);
			if ( (ezert$$8 > 0) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,116,3299,16, this);
					this.setSelection(1 );
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,108,3093,234, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getValueAsText": function() {
		...
		try { egl.enter("getValueAsText",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,121,3398,14, this);
			var ezert$$9 = 0;
			ezert$$9 = this.getSelection();
			egl.atLine(this.eze$$fileName,121,3383,32, this);
			var ezert$$10 = 0;
			ezert$$10 = ezert$$9;
