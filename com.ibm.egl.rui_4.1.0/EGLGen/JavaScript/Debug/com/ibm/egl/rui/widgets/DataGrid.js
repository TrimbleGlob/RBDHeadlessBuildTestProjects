...
egl.defineRUIWidget('com.ibm.egl.rui.widgets', 'DataGrid', {
				...
				try{egl.enterBlock();
					...
					if ( (uiCount >= 1) ) {
						try{egl.enterBlock();
							...
							var ezert$$39 = 0;
							ezert$$39 = Math.max( egl.convertDecimalToInt(new egl.javascript.BigDecimal(egl.divide(egl.checkNull(this.ui, "ui").getPixelHeight(), 2)).subtract(egl.convertIntegerToDecimal(12, egl.javascript.BigDecimal.prototype.NINES[3]))) ,0 );
							...
							var ezert$$40 = 0;
							ezert$$40 = Math.max( egl.convertDecimalToInt(new egl.javascript.BigDecimal(egl.divide(egl.checkNull(this.ui, "ui").getChildren()[egl.checkNull(this.ui, "ui").getChildren().checkIndex((1)-1)].getPixelWidth(), 2)).subtract(egl.convertIntegerToDecimal(20, egl.javascript.BigDecimal.prototype.NINES[3]))) ,0 );
							...
							egl.checkNull(this.loadingDiv, "loadingDiv").setHeight((new egl.javascript.BigDecimal(egl.divide(egl.checkNull(this.ui, "ui").getPixelHeight(), 2)).add(egl.convertIntegerToDecimal(12, egl.javascript.BigDecimal.prototype.NINES[3]))).toString());
						}finally{egl.exitBlock();}
					}
					else {
						try{egl.enterBlock();
	...
	"getPageCount": function() {
		...
		try { egl.enter("getPageCount",this,arguments,eze$$updater);
			...
			var ezert$$103 = 0;
			ezert$$103 = ezert$$102;
			$result = egl.convertDecimalToInt(new egl.javascript.BigDecimal(egl.divide((ezert$$103 - 1), this.pageSize)).add(egl.convertIntegerToDecimal(1, egl.javascript.BigDecimal.prototype.NINES[3])),egl.createRuntimeException);
			egl.setLocalFunctionVariable("INT", $result, "int");
			{ if (!egl.debugg) egl.leave(); return $result;}
		} finally {
			if (!egl.debugg){
	...
	"gotoEnd": function( e ) {
		...
		try { egl.enter("gotoEnd",this,arguments,eze$$updater);
			...
			pageCount = egl.convertDecimalToInt(new egl.javascript.BigDecimal(egl.divide((ezert$$104 - 1), this.pageSize)).add(egl.convertIntegerToDecimal(1, egl.javascript.BigDecimal.prototype.NINES[3])),egl.createRuntimeException);
			egl.setLocalFunctionVariable("pageCount", pageCount, "int");
			var leftOver = 0;
