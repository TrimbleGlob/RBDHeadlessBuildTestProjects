...
egl.defineRUIWidget('com.ibm.egl.rui.widgets', 'HyperLink', {
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,19,535,85, this);
			this.text = "";
			egl.atLine(this.eze$$fileName,20,622,91, this);
			this.target = "";
			egl.atLine(this.eze$$fileName,21,715,85, this);
			this.href = "";
			egl.atLine(this.eze$$fileName,22,802,43, this);
			this.hyperChild = new egl.egl.ui.rui.Widget();
			egl.addEmbeddedWidget(this, "hyperChild");
			
			egl.atLine(this.eze$$fileName,23,847,69, this);
			this.hyperParent = new egl.egl.ui.rui.Widget();
			egl.addEmbeddedWidget(this, "hyperParent");
			
			this.jsrt$SysVar= new egl.egl.core.SysVar();
			egl.atLine(this.eze$$fileName,11,315,26, this);
			this.targetWidget = this.hyperParent;
			egl.atLine(this.eze$$fileName,22,829,13, this);
			this.hyperChild.setTagName( "a" );
			egl.atLine(this.eze$$fileName,23,874,15, this);
			this.hyperParent.setTagName( "div" );
			egl.atLine(this.eze$$fileName,23,891,23, this);
	...
	"getText": function() {
		...
		try { egl.enter("getText",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,26,958,14, this);
			$result = this.text;
	...
	"setText": function( textIn ) {
		...
		try { egl.enter("setText",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,29,1016,14, this);
			this.text = textIn;
			egl.atLine(this.eze$$fileName,30,1033,28, this);
			this.hyperChild.setInnerHTML( this.text );
			egl.atLine(this.eze$$fileName,28,979,87, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getTarget": function() {
		...
		try { egl.enter("getTarget",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,34,1110,16, this);
			$result = this.target;
			egl.setLocalFunctionVariable("STRING", $result, "string");
			{ if (!egl.debugg) egl.leave(); return $result;}
		} finally {
	...
	"setTarget": function( targetIn ) {
		...
		try { egl.enter("setTarget",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,37,1174,18, this);
			this.target = targetIn;
			egl.atLine(this.eze$$fileName,38,1195,42, this);
			this.hyperChild.setAttribute("target", this.target );
			egl.atLine(this.eze$$fileName,36,1133,109, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getHref": function() {
		...
		try { egl.enter("getHref",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,42,1284,14, this);
			$result = this.href;
			egl.setLocalFunctionVariable("STRING", $result, "string");
			{ if (!egl.debugg) egl.leave(); return $result;}
		} finally {
	...
	"setHref": function( hrefIn ) {
		...
		try { egl.enter("setHref",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,45,1342,14, this);
			this.href = hrefIn;
			egl.atLine(this.eze$$fileName,46,1359,38, this);
			this.hyperChild.setAttribute("href", this.href );
			egl.atLine(this.eze$$fileName,44,1305,97, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
