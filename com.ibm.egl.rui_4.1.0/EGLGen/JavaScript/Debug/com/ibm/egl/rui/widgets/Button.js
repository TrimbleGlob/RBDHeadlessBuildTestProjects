...
egl.defineRUIWidget('com.ibm.egl.rui.widgets', 'Button', {
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,21,589,83, this);
			this.text = "";
	...
	"setText": function( textIn ) {
		...
		try { egl.enter("setText",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,24,720,14, this);
			this.text = textIn;
			egl.atLine(this.eze$$fileName,25,737,30, this);
			this.setAttribute("value", {eze$$value : textIn, eze$$signature : "S;"} );
			var isVisual = false;
			egl.addLocalFunctionVariable("isVisual", isVisual, "boolean", "isVisual");
			egl.atLine(this.eze$$fileName,26,770,8, this);
			...
			egl.atLine(this.eze$$fileName,27,820,18, this);
			...
			egl.atLine(this.eze$$fileName,28,889,94, this);
			if ( (isVisual || isReverseDirection) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,29,927,50, this);
					this.setBiDiMarkers(isVisual, isReverseDirection );
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,23,675,315, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getText": function() {
		...
		try { egl.enter("getText",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,34,1040,103, this);
			if ( ((this.getTextLayout() == "Visual") || (this.getReverseTextDirection() == "Yes")) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,35,1113,24, this);
					this.cleanBiDiMarkers();
				}finally{egl.exitBlock();}
			}
			var ezert$$1 = null;
			ezert$$1 = this.getAttribute("value" );
			egl.atLine(this.eze$$fileName,37,1149,42, this);
			var ezert$$2 = null;
			ezert$$2 = ezert$$1;
