...
egl.defineRUIWidget('com.ibm.egl.rui.widgets', 'Shadow', {
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,13,332,86, this);
			...
			egl.atLine(this.eze$$fileName,13,395,20, this);
	...
	"getDiv": function() {
		...
		try { egl.enter("getDiv",this,arguments,eze$$updater);
			var $result = null;
			egl.atLine(this.eze$$fileName,32,846,14, this);
			$result = this.div;
