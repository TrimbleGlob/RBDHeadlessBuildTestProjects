...
egl.defineRUIWidget('com.ibm.egl.rui.widgets', 'Box', {
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,25,636,22, this);
			this.lastRow = null;
			egl.addEmbeddedWidget(this, "lastRow");
			
			egl.atLine(this.eze$$fileName,26,660,34, this);
			this.body = new egl.egl.ui.rui.Widget();
			egl.addEmbeddedWidget(this, "body");
			
			egl.atLine(this.eze$$fileName,27,696,82, this);
			this.table = new egl.egl.ui.rui.Widget();
			egl.addEmbeddedWidget(this, "table");
			
			egl.atLine(this.eze$$fileName,28,780,32, this);
			this.div = new egl.com.ibm.egl.rui.widgets.Div();
			egl.addEmbeddedWidget(this, "div");
			
			egl.atLine(this.eze$$fileName,29,814,538, this);
			this.alignment = 0;
			egl.atLine(this.eze$$fileName,39,1356,42, this);
			this.widgetOrientationThis = "";
			egl.atLine(this.eze$$fileName,40,1401,28, this);
			this.cells = null;
			
			egl.atLine(this.eze$$fileName,41,1431,98, this);
			this.columns = 0;
			this.jsrt$SysVar= new egl.egl.core.SysVar();
			new egl.com.ibm.egl.rui.widgets.BoxLib();
			new egl.com.ibm.egl.rui.widgets.UtilLib();
			egl.atLine(this.eze$$fileName,14,362,18, this);
			this.targetWidget = this.div;
			egl.atLine(this.eze$$fileName,25,636,7, this);
			this.lastRow = null;
			egl.atLine(this.eze$$fileName,26,674,17, this);
			this.body.setTagName( "tbody" );
			egl.atLine(this.eze$$fileName,27,711,17, this);
			this.table.setTagName( "table" );
			egl.atLine(this.eze$$fileName,27,730,19, this);
			this.table.setChildren( [ this.body ] );
			egl.atLine(this.eze$$fileName,27,751,24, this);
			this.table.setClass( "EglRuiBoxTable" );
			egl.atLine(this.eze$$fileName,28,790,20, this);
			egl.checkNull(this.div, "div").setChildren( [ this.table ] );
			egl.atLine(this.eze$$fileName,39,1364,21, this);
			this.widgetOrientationThis = "";
			egl.atLine(this.eze$$fileName,40,1409,5, this);
			this.cells = [  ];
			egl.atLine(this.eze$$fileName,41,1431,7, this);
			this.columns = 32768;
	...
	"setChildren": function( children ) {
		...
		try { egl.enter("setChildren",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,44,1590,96, this);
			if ( (children == null) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,45,1615,65, this);
					throw (function () {
						var ezert$$1 = egl.createRuntimeException();
						egl.atLine(this.eze$$fileName,45,1644,33, this);
						egl.checkNull(ezert$$1, "ezert$$1").message = "Children cannot be null";
						return ezert$$1;
					}).call(this);
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,47,1689,17, this);
			this.removeChildren();
			egl.atLine(this.eze$$fileName,48,1709,193, this);
			if ( (this.widgetOrientationThis != "") ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,49,1744,46, this);
					egl.checkNull(this.div, "div").setWidgetOrientation(this.widgetOrientationThis);
					egl.atLine(this.eze$$fileName,50,1794,102, this);
					if ( (this.widgetOrientationThis == "RTL") ) {
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,51,1834,19, this);
							this.alignment = 2;
						}finally{egl.exitBlock();}
					}
					else {
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,53,1866,19, this);
							this.alignment = 0;
						}finally{egl.exitBlock();}
					}
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,57,1910,88, this);
			{
				try{egl.enterBlock();
					var index = 0;
					...
					for ( ; (index <= children.getSize()); index = (index + 1) )
					{
						egl.setLocalFunctionVariable("index", index, "int");
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,58,1963,29, this);
			...
			egl.atLine(this.eze$$fileName,43,1533,470, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getChildren": function() {
		...
		try { egl.enter("getChildren",this,arguments,eze$$updater);
			var $result = null;
			egl.atLine(this.eze$$fileName,63,2062,15, this);
			$result = this.cells;
	...
	"appendChild": function( newChild ) {
		...
		try { egl.enter("appendChild",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,67,2142,100, this);
			if ( (newChild == null) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,68,2167,69, this);
					throw (function () {
						var ezert$$2 = egl.createRuntimeException();
						egl.atLine(this.eze$$fileName,68,2196,37, this);
						egl.checkNull(ezert$$2, "ezert$$2").message = "Child to add cannot be null";
						return ezert$$2;
					}).call(this);
				}finally{egl.exitBlock();}
			}
			...
			egl.atLine(this.eze$$fileName,70,2245,5, this);
			...
			egl.atLine(this.eze$$fileName,72,2282,134, this);
			if ( (this.widgetOrientationThis != "") ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,73,2317,93, this);
					if ( (child.getWidgetOrientation() == "") ) {
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,74,2355,48, this);
			...
			egl.atLine(this.eze$$fileName,78,2435,12, this);
			td.setTagName( "td" );
			egl.atLine(this.eze$$fileName,78,2449,18, this);
			td.setChildren( [ child ] );
			egl.atLine(this.eze$$fileName,79,2473,41, this);
			td.setClass( "EglRuiVAlignTop EglRuiBoxTd" );
			egl.atLine(this.eze$$fileName,80,2517,292, this);
			switch( this.alignment ) {
				case 0:
					egl.atLine(this.eze$$fileName,81,2537,84, this);
					try{egl.enterBlock();
						egl.atLine(this.eze$$fileName,82,2549,34, this);
						egl.checkNull(this.div, "div").setAttribute("align", {eze$$value : "left", eze$$signature : "S;"} );
						egl.atLine(this.eze$$fileName,83,2588,33, this);
						td.setAttribute("align", "left" );
					}finally{egl.exitBlock();}
					break;
				case 1:
					egl.atLine(this.eze$$fileName,84,2625,88, this);
					try{egl.enterBlock();
						egl.atLine(this.eze$$fileName,85,2637,36, this);
						egl.checkNull(this.div, "div").setAttribute("align", {eze$$value : "center", eze$$signature : "S;"} );
						egl.atLine(this.eze$$fileName,86,2678,35, this);
						td.setAttribute("align", "center" );
					}finally{egl.exitBlock();}
					break;
				case 2:
					egl.atLine(this.eze$$fileName,87,2717,86, this);
					try{egl.enterBlock();
						egl.atLine(this.eze$$fileName,88,2729,35, this);
						egl.checkNull(this.div, "div").setAttribute("align", {eze$$value : "right", eze$$signature : "S;"} );
						egl.atLine(this.eze$$fileName,89,2769,34, this);
			...
			egl.atLine(this.eze$$fileName,91,2812,27, this);
			child.setLogicalParent(  this );
			egl.atLine(this.eze$$fileName,92,2842,24, this);
			td.setLogicalParent(  this );
			var eze_Cond_Temp_0 = false;
			egl.atLine(this.eze$$fileName,93,2873,72, this);
			if ( ((this.lastRow == null) || (this.columns == 1)) ) {
				...
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,93,2908,26, this);
					var ezert$$3 = 0;
					ezert$$3 = this.lastRow.getChildren().getSize();
					egl.atLine(this.eze$$fileName,93,2873,72, this);
					if ( (ezert$$3 >= this.columns) ) {
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,93,2873,72, this);
							eze_Cond_Temp_0 = true;
						}finally{egl.exitBlock();}
			...
			egl.atLine(this.eze$$fileName,93,2869,155, this);
			if ( eze_Cond_Temp_0 ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,94,2950,38, this);
					this.lastRow = (function () {
						var ezert$$4 = new egl.egl.ui.rui.Widget();
						egl.atLine(this.eze$$fileName,94,2973,12, this);
						ezert$$4.setTagName( "tr" );
						return ezert$$4;
					}).call(this);
					egl.atLine(this.eze$$fileName,95,2992,26, this);
					this.body.appendChild(this.lastRow );
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,97,3027,24, this);
			this.lastRow.appendChild(td );
			egl.atLine(this.eze$$fileName,98,3054,27, this);
			this.cells.appendElement( child );
			egl.atLine(this.eze$$fileName,66,2086,1000, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"removeChild": function( child ) {
		...
		try { egl.enter("removeChild",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,102,3142,9, this);
			tempCells = this.cells;
			egl.setLocalFunctionVariable("tempCells", tempCells, "egl.ui.rui.Widget[]");
			egl.atLine(this.eze$$fileName,103,3172,17, this);
			this.removeChildren();
			egl.atLine(this.eze$$fileName,104,3192,173, this);
			{
				try{egl.enterBlock();
					var index = 0;
					egl.addLocalFunctionVariable("index", index, "int", "index");
					...
					for ( ; (index <= tempCells.getSize()); index = (index + 1) )
					{
						egl.setLocalFunctionVariable("index", index, "int");
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,105,3246,113, this);
							if ( (egl.checkNull(tempCells, "tempCells")[tempCells.checkIndex((index)-1)] == child) ) {
								try{egl.enterBlock();
									egl.atLine(this.eze$$fileName,106,3281,31, this);
									tempCells.removeElement( index );
									egl.atLine(this.eze$$fileName,107,3317,23, this);
									this.setChildren(tempCells );
									egl.atLine(this.eze$$fileName,108,3345,7, this);
			...
			egl.atLine(this.eze$$fileName,101,3090,280, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"removeChildren": function() {
		...
		try { egl.enter("removeChildren",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,114,3415,214, this);
			{
				try{egl.enterBlock();
					var i = 0;
					...
					for ( ; (i <= this.cells.getSize()); i = (i + 1) )
					{
						egl.setLocalFunctionVariable("i", i, "int");
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,115,3455,168, this);
							if ( ((egl.checkNull(this.cells, "cells")[this.cells.checkIndex((i)-1)].getLogicalParent() ==  this) && (egl.checkNull(this.cells, "cells")[this.cells.checkIndex((i)-1)].getParent() != null)) ) {
								try{egl.enterBlock();
									egl.atLine(this.eze$$fileName,116,3578,38, this);
			...
			egl.atLine(this.eze$$fileName,119,3632,36, this);
			egl.com.ibm.egl.rui.widgets.UtilLib['$inst'].destroyWidgetChildren(this.body );
			egl.atLine(this.eze$$fileName,120,3671,11, this);
			this.cells = [  ];
			egl.atLine(this.eze$$fileName,121,3685,15, this);
			this.lastRow = null;
			egl.atLine(this.eze$$fileName,113,3374,331, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"layout": function() {
		...
		try { egl.enter("layout",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,125,3729,19, this);
			this.setChildren(this.cells );
			egl.atLine(this.eze$$fileName,124,3709,44, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setColumns": function( columns ) {
		...
		try { egl.enter("setColumns",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,129,3795,23, this);
			this.columns = columns;
			egl.atLine(this.eze$$fileName,130,3821,9, this);
			this.layout();
			egl.atLine(this.eze$$fileName,128,3757,78, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getColumns": function() {
		...
		try { egl.enter("getColumns",this,arguments,eze$$updater);
			var $result = 0;
			egl.atLine(this.eze$$fileName,134,3876,22, this);
			$result = this.columns;
	...
	"setAlignment": function( align ) {
		...
		try { egl.enter("setAlignment",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,138,3945,18, this);
			this.alignment = align;
			egl.atLine(this.eze$$fileName,139,3966,22, this);
			this.setChildren(this.getChildren() );
			egl.atLine(this.eze$$fileName,137,3907,86, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getAlignment": function() {
		...
		try { egl.enter("getAlignment",this,arguments,eze$$updater);
			var $result = 0;
			egl.atLine(this.eze$$fileName,143,4037,19, this);
	...
	"getWidgetOrientation": function() {
		...
		try { egl.enter("getWidgetOrientation",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,147,4129,36, this);
	...
	"setWidgetOrientation": function( widgetOrientation ) {
		...
		try { egl.enter("setWidgetOrientation",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,151,4249,47, this);
			this.widgetOrientationThis = widgetOrientation;
			var eze_Cond_Temp_1 = false;
			egl.atLine(this.eze$$fileName,152,4304,50, this);
			if ( (this.widgetOrientationThis != "") ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,152,4335,15, this);
					var ezert$$5 = 0;
					ezert$$5 = this.cells.getSize();
					egl.atLine(this.eze$$fileName,152,4304,50, this);
					if ( (ezert$$5 > 0) ) {
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,152,4304,50, this);
			...
			egl.atLine(this.eze$$fileName,152,4301,421, this);
			if ( eze_Cond_Temp_1 ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,153,4359,46, this);
					egl.checkNull(this.div, "div").setWidgetOrientation(this.widgetOrientationThis);
					egl.atLine(this.eze$$fileName,154,4409,133, this);
					if ( (this.widgetOrientationThis == "RTL") ) {
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,155,4449,35, this);
							egl.checkNull(this.div, "div").setAttribute("align", {eze$$value : "right", eze$$signature : "S;"} );
						}finally{egl.exitBlock();}
					}
					else {
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,157,4497,34, this);
							egl.checkNull(this.div, "div").setAttribute("align", {eze$$value : "left", eze$$signature : "S;"} );
						}finally{egl.exitBlock();}
					}
					egl.atLine(this.eze$$fileName,159,4546,167, this);
					{
						try{egl.enterBlock();
							var index = 0;
							egl.addLocalFunctionVariable("index", index, "int", "index");
							...
							for ( ; (index <= this.cells.getSize()); index = (index + 1) )
							{
								egl.setLocalFunctionVariable("index", index, "int");
								try{egl.enterBlock();
									egl.atLine(this.eze$$fileName,160,4597,109, this);
									if ( (egl.checkNull(this.cells, "cells")[this.cells.checkIndex((index)-1)].getWidgetOrientation() == "") ) {
										try{egl.enterBlock();
											egl.atLine(this.eze$$fileName,161,4643,55, this);
			...
			egl.atLine(this.eze$$fileName,150,4174,555, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setReverseTextDirection": function( reverseTextDirection ) {
		...
		try { egl.enter("setReverseTextDirection",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,167,4733,84, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getReverseTextDirection": function() {
		...
		try { egl.enter("getReverseTextDirection",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,171,4889,12, this);
			$result = "";
			egl.setLocalFunctionVariable("STRING", $result, "string");
			{ if (!egl.debugg) egl.leave(); return $result;}
		} finally {
