...
egl.defineRUIWidget('com.ibm.egl.rui.widgets', 'Tooltip', {
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,17,411,29, this);
			this.provider = null;
			
			egl.atLine(this.eze$$fileName,18,442,16, this);
			this.delay = 0;
			egl.atLine(this.eze$$fileName,19,460,19, this);
			this.text = "";
			egl.atLine(this.eze$$fileName,21,483,117, this);
			this.container = new egl.com.ibm.egl.rui.widgets.Div();
			egl.addEmbeddedWidget(this, "container");
			
			egl.atLine(this.eze$$fileName,26,602,42, this);
			this.shadow = new egl.com.ibm.egl.rui.widgets.Shadow();
			egl.addEmbeddedWidget(this, "shadow");
			
			egl.atLine(this.eze$$fileName,27,646,100, this);
			this.tooltip = new egl.com.ibm.egl.rui.widgets.Box();
			egl.addEmbeddedWidget(this, "tooltip");
			
			egl.atLine(this.eze$$fileName,28,748,64, this);
			this.defaultTip = new egl.com.ibm.egl.rui.widgets.Box();
			egl.addEmbeddedWidget(this, "defaultTip");
			
			egl.atLine(this.eze$$fileName,30,816,50, this);
			this.showJob = new egl.egl.javascript.Job();
			
			egl.atLine(this.eze$$fileName,31,868,50, this);
			this.hideJob = new egl.egl.javascript.Job();
			
			egl.atLine(this.eze$$fileName,32,920,29, this);
			this.insideTarget = false;
			this.jsrt$SysVar= new egl.egl.core.SysVar();
			new egl.egl.core.MathLib();
			new egl.egl.core.StrLib();
			egl.atLine(this.eze$$fileName,18,442,5, this);
			this.delay = 400;
			egl.atLine(this.eze$$fileName,19,460,4, this);
			this.text = "";
			egl.atLine(this.eze$$fileName,22,510,23, this);
			egl.checkNull(this.container, "container").setClass("EglRuiTooltip");
			egl.atLine(this.eze$$fileName,23,537,28, this);
			...
			egl.atLine(this.eze$$fileName,24,569,27, this);
			...
			egl.atLine(this.eze$$fileName,26,626,15, this);
			egl.checkNull(this.shadow, "shadow").setDiv(this.container);
			egl.atLine(this.eze$$fileName,27,668,19, this);
			egl.checkNull(this.tooltip, "tooltip").setChildren( [ this.shadow ] );
			egl.atLine(this.eze$$fileName,27,689,19, this);
			egl.checkNull(this.tooltip, "tooltip").setVisibility("hidden");
			egl.atLine(this.eze$$fileName,27,710,11, this);
			egl.checkNull(this.tooltip, "tooltip").setZIndex("99");
			egl.atLine(this.eze$$fileName,27,724,19, this);
			egl.checkNull(this.tooltip, "tooltip").setPosition("absolute");
			egl.atLine(this.eze$$fileName,28,773,36, this);
			egl.checkNull(this.defaultTip, "defaultTip").setChildren( [ (function () {
				var ezert$$1 = new egl.com.ibm.egl.rui.widgets.HTML();
				return ezert$$1;
			}).call(this) ] );
			egl.atLine(this.eze$$fileName,30,838,25, this);
			...
			egl.atLine(this.eze$$fileName,31,890,25, this);
	...
	"start": function() {
		...
		try { egl.enter("start",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,35,972,35, this);
			this.document.body.appendChild(this.tooltip );
			egl.atLine(this.eze$$fileName,34,953,59, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"enable": function( widget ) {
		...
		try { egl.enter("enable",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,39,1054,39, this);
			...
			egl.atLine(this.eze$$fileName,40,1096,40, this);
			...
			egl.atLine(this.eze$$fileName,41,1139,32, this);
			...
			egl.atLine(this.eze$$fileName,38,1018,158, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"deactivateTooltip": function( e ) {
		...
		try { egl.enter("deactivateTooltip",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,45,1221,24, this);
			this.hideJob.schedule(this.delay );
			egl.atLine(this.eze$$fileName,46,1248,21, this);
			this.insideTarget = false;
			egl.atLine(this.eze$$fileName,44,1180,94, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"activateTooltip": function( e ) {
		...
		try { egl.enter("activateTooltip",this,arguments,eze$$updater);
			egl.addLocalFunctionVariable("e", e, "egl.ui.rui.Event", "e");
			egl.atLine(this.eze$$fileName,50,1317,20, this);
			this.insideTarget = true;
			var widget = null;
			egl.addLocalFunctionVariable("widget", widget, "egl.ui.rui.Widget", "widget");
			egl.atLine(this.eze$$fileName,51,1340,6, this);
			widget = e.widget;
			...
			egl.atLine(this.eze$$fileName,52,1368,3, this);
			tip = null;
			egl.setLocalFunctionVariable("tip", tip, "com.ibm.egl.rui.widgets.Box");
			egl.atLine(this.eze$$fileName,53,1386,142, this);
			if ( ((this.provider == null) && (this.text != null)) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,54,1427,17, this);
					tip = this.defaultTip;
					egl.setLocalFunctionVariable("tip", tip, "com.ibm.egl.rui.widgets.Box");
					egl.atLine(this.eze$$fileName,55,1448,38, this);
				...
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,57,1503,18, this);
					var ezert$$2 = null;
					ezert$$2 = this.provider((function(x){ return x !== null ? ({eze$$value : x, eze$$signature : "Tegl/ui/rui/widget;"}) : null; })(e.widget) );
					egl.atLine(this.eze$$fileName,57,1497,25, this);
					tip = ezert$$2;
					egl.setLocalFunctionVariable("tip", tip, "com.ibm.egl.rui.widgets.Box");
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,59,1531,824, this);
			if ( (tip != null) ) {
				try{egl.enterBlock();
					var h = 0;
					egl.addLocalFunctionVariable("h", h, "int", "h");
					egl.atLine(this.eze$$fileName,60,1551,1, this);
					h = 10;
					egl.setLocalFunctionVariable("h", h, "int");
					egl.atLine(this.eze$$fileName,61,1566,510, this);
					if ( (widget.getHeight() != "auto") ) {
						try{egl.enterBlock();
							var hs = "";
							egl.addLocalFunctionVariable("hs", hs, "string", "hs");
							egl.atLine(this.eze$$fileName,62,1611,2, this);
							hs = widget.getHeight();
							egl.setLocalFunctionVariable("hs", hs, "string");
							egl.atLine(this.eze$$fileName,63,1654,415, this);
							if ( egl.is(hs, "NUMERIC",egl.isnumeric) ) {
								try{egl.enterBlock();
									egl.atLine(this.eze$$fileName,64,1695,7, this);
								...
								try{egl.enterBlock();
									...
									egl.atLine(this.eze$$fileName,68,1895,23, this);
									var ezert$$3 = 0;
									ezert$$3 = egl.egl.core.$StrLib.textLen( hs);
									egl.atLine(this.eze$$fileName,68,1885,3, this);
									len = ezert$$3;
									egl.setLocalFunctionVariable("len", len, "int");
									egl.atLine(this.eze$$fileName,69,1940,109, this);
									if ( ((len > 2) && egl.is(hs.substring( 1-1,(len - 2)), "NUMERIC",egl.isnumeric)) ) {
										try{egl.enterBlock();
											egl.atLine(this.eze$$fileName,70,2007,18, this);
					...
					egl.atLine(this.eze$$fileName,74,2088,43, this);
					var ezert$$4 = 0;
					ezert$$4 = Math.min( ((widget.getY() + h) - 3) ,(e.pageY + 10) );
					egl.atLine(this.eze$$fileName,74,2080,1, this);
					y = ezert$$4;
					egl.setLocalFunctionVariable("y", y, "int");
					egl.atLine(this.eze$$fileName,75,2138,27, this);
					egl.checkNull(this.container, "container").removeChildren();
					egl.atLine(this.eze$$fileName,76,2169,37, this);
					egl.checkNull(this.container, "container").setChildren( [ tip ] );
					egl.atLine(this.eze$$fileName,77,2210,22, this);
					egl.checkNull(this.container, "container").setOpacity((new egl.javascript.BigDecimal("1.0")).toString(1));
					egl.atLine(this.eze$$fileName,78,2236,21, this);
					egl.checkNull(this.tooltip, "tooltip").setX(e.pageX);
					egl.atLine(this.eze$$fileName,79,2261,14, this);
					egl.checkNull(this.tooltip, "tooltip").setY(y);
					egl.atLine(this.eze$$fileName,80,2279,17, this);
					this.hideJob.cancel();
					egl.atLine(this.eze$$fileName,81,2300,24, this);
					this.showJob.schedule(this.delay );
				}finally{egl.exitBlock();}
			}
			else {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,83,2335,14, this);
					this.hideTooltip();
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,85,2358,20, this);
			e.stopPropagation();
			egl.atLine(this.eze$$fileName,49,1278,1105, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"showTooltip": function() {
		...
		try { egl.enter("showTooltip",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,89,2412,58, this);
			if ( this.insideTarget ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,90,2433,31, this);
					egl.checkNull(this.tooltip, "tooltip").setVisibility("visible");
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,88,2387,88, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"hideTooltip": function() {
		...
		try { egl.enter("hideTooltip",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,95,2504,37, this);
			...
			egl.atLine(this.eze$$fileName,96,2544,21, this);
			this.insideTarget = false;
			egl.atLine(this.eze$$fileName,94,2479,91, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setInvisible": function() {
		...
		try { egl.enter("setInvisible",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,100,2600,24, this);
			egl.checkNull(this.container, "container").setOpacity((new egl.javascript.BigDecimal("1.0")).toString(1));
			egl.atLine(this.eze$$fileName,101,2627,30, this);
			egl.checkNull(this.tooltip, "tooltip").setVisibility("hidden");
			egl.atLine(this.eze$$fileName,99,2574,88, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"enterTooltip": function( e ) {
		...
		try { egl.enter("enterTooltip",this,arguments,eze$$updater);
			egl.addLocalFunctionVariable("e", e, "egl.ui.rui.Event", "e");
			egl.atLine(this.eze$$fileName,105,2702,17, this);
			this.hideJob.cancel();
			egl.atLine(this.eze$$fileName,104,2666,58, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"leaveTooltip": function( e ) {
		...
		try { egl.enter("leaveTooltip",this,arguments,eze$$updater);
			egl.addLocalFunctionVariable("e", e, "egl.ui.rui.Event", "e");
			egl.atLine(this.eze$$fileName,108,2762,22, this);
			this.hideJob.schedule(200 );
			egl.atLine(this.eze$$fileName,107,2726,63, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
