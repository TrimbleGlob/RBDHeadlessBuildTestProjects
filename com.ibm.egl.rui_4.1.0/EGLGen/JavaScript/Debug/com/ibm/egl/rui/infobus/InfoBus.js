...
egl.defineRUILibrary( 'com.ibm.egl.rui.infobus', 'InfoBus',
	{
		...
		"constructor" : function()
		{
			...
			try { egl.enter("<init>",this,arguments,eze$$updater);
				...
				egl.atLine(this.eze$$fileName,21,445,28, this);
		...
		"subscribe": function( name, callback, eze$$callback$func_, eze$$caller ) {
			...
			try { egl.enter("subscribe",this,arguments,eze$$updater);
				...
				egl.atLine(this.eze$$fileName,28,740,32, this);
				var ezert$$1 = null;
				ezert$$1 = this.bridge.subscribe(name, callback, function(eze$$inout$callback) {
				...
				egl.setLocalFunctionVariable("callback", callback, "com.ibm.egl.rui.infobus.InfoBusCallback");
				egl.atLine(this.eze$$fileName,28,732,42, this);
				$result = ezert$$1;
		...
		"unsubscribe": function( subscription ) {
			...
			try { egl.enter("unsubscribe",this,arguments,eze$$updater);
				...
				egl.atLine(this.eze$$fileName,35,894,33, this);
				this.bridge.unsubscribe(egl.unboxAny(subscription) );
				egl.atLine(this.eze$$fileName,34,847,88, this);
				{ if (!egl.debugg) egl.leave(); }
			} finally {
				if (!egl.debugg){
				} else { egl.leave(); }
		...
		"publish": function( name, data ) {
			...
			try { egl.enter("publish",this,arguments,eze$$updater);
				...
				egl.atLine(this.eze$$fileName,43,1128,27, this);
				this.bridge.publish(name, egl.unboxAny(data) );
				egl.atLine(this.eze$$fileName,42,1077,86, this);
				{ if (!egl.debugg) egl.leave(); }
			} finally {
				if (!egl.debugg){
				} else { egl.leave(); }
