...
egl.defineRUIWidget('com.ibm.egl.rui.widgets', 'TextArea', {
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,41,1292,36, this);
			this.savedBackgroundColor = "";
			egl.atLine(this.eze$$fileName,43,1332,85, this);
			this.text = "";
			egl.atLine(this.eze$$fileName,44,1419,94, this);
			this.readOnly = false;
			egl.atLine(this.eze$$fileName,45,1515,91, this);
			this.numRows = 0;
			egl.atLine(this.eze$$fileName,46,1608,100, this);
			this.numColumns = 0;
			egl.atLine(this.eze$$fileName,48,1712,25, this);
			...
			egl.atLine(this.eze$$fileName,49,1739,30, this);
			this.redraw = false;
			egl.atLine(this.eze$$fileName,50,1771,37, this);
			this.savedEnableSelection = false;
			this.jsrt$SysVar= new egl.egl.core.SysVar();
			new egl.egl.ui.rui.RUILib();
			egl.atLine(this.eze$$fileName,49,1747,6, this);
			this.redraw = true;
	...
	"start": function() {
		...
		try { egl.enter("start",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,53,1831,34, this);
			...
			egl.atLine(this.eze$$fileName,54,1868,33, this);
			...
			egl.atLine(this.eze$$fileName,52,1812,94, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"enableSelection": function( e ) {
		...
		try { egl.enter("enableSelection",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,58,1972,32, this);
			var ezert$$2 = false;
			ezert$$2 = egl.egl.ui.rui.RUILib['$inst'].getTextSelectionEnabled();
			egl.atLine(this.eze$$fileName,58,1949,56, this);
			this.savedEnableSelection = ezert$$2;
			egl.atLine(this.eze$$fileName,59,2008,37, this);
			egl.egl.ui.rui.RUILib['$inst'].setTextSelectionEnabled(true );
			egl.atLine(this.eze$$fileName,57,1910,140, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"disableSelection": function( e ) {
		...
		try { egl.enter("disableSelection",this,arguments,eze$$updater);
			egl.addLocalFunctionVariable("e", e, "egl.ui.rui.Event", "e");
			egl.atLine(this.eze$$fileName,63,2094,53, this);
			egl.egl.ui.rui.RUILib['$inst'].setTextSelectionEnabled(this.savedEnableSelection );
			egl.atLine(this.eze$$fileName,62,2054,98, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"append": function( text ) {
		...
		try { egl.enter("append",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,67,2190,84, this);
			if ( this.redraw ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,68,2212,9, this);
					var ezert$$3 = "";
					ezert$$3 = this.getText();
					egl.atLine(this.eze$$fileName,68,2204,26, this);
					this.setText((ezert$$3 + text) );
				}finally{egl.exitBlock();}
			}
			else {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,70,2241,27, this);
					this.buffer.appendElement( text );
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,66,2156,123, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setRedraw": function( draw ) {
		...
		try { egl.enter("setRedraw",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,75,2321,14, this);
			this.redraw = draw;
			var bufSize = 0;
			egl.addLocalFunctionVariable("bufSize", bufSize, "int", "bufSize");
			egl.atLine(this.eze$$fileName,76,2352,16, this);
			var ezert$$4 = 0;
			ezert$$4 = this.buffer.getSize();
			egl.atLine(this.eze$$fileName,76,2338,7, this);
			bufSize = ezert$$4;
			egl.setLocalFunctionVariable("bufSize", bufSize, "int");
			egl.atLine(this.eze$$fileName,77,2372,151, this);
			if ( (this.redraw && (bufSize > 0)) ) {
				try{egl.enterBlock();
					var s = "";
					egl.addLocalFunctionVariable("s", s, "string", "s");
					egl.atLine(this.eze$$fileName,79,2414,62, this);
					{
						try{egl.enterBlock();
							var i = 0;
							...
							for ( ; (i <= bufSize); i = (i + 1) )
							{
								egl.setLocalFunctionVariable("i", i, "int");
								try{egl.enterBlock();
									egl.atLine(this.eze$$fileName,80,2447,22, this);
					...
					egl.atLine(this.eze$$fileName,82,2480,10, this);
					this.append(s );
					egl.atLine(this.eze$$fileName,83,2494,23, this);
			...
			egl.atLine(this.eze$$fileName,74,2283,245, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getNumRows": function() {
		...
		try { egl.enter("getNumRows",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,88,2568,38, this);
			this.numRows = egl.convertAnyToInt(ezert$$6,false);
			egl.atLine(this.eze$$fileName,89,2609,17, this);
			$result = this.numRows;
	...
	"setNumRows": function( rows ) {
		...
		try { egl.enter("setNumRows",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,93,2670,15, this);
			this.numRows = rows;
			egl.atLine(this.eze$$fileName,94,2688,27, this);
			this.setAttribute("rows", {eze$$value : rows, eze$$signature : "I;"} );
			egl.atLine(this.eze$$fileName,92,2635,85, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getNumColumns": function() {
		...
		try { egl.enter("getNumColumns",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,98,2764,41, this);
			this.numColumns = egl.convertAnyToInt(ezert$$7,false);
			egl.atLine(this.eze$$fileName,99,2808,19, this);
	...
	"setNumColumns": function( cols ) {
		...
		try { egl.enter("setNumColumns",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,103,2874,18, this);
			this.numColumns = cols;
			egl.atLine(this.eze$$fileName,104,2895,27, this);
			this.setAttribute("cols", {eze$$value : cols, eze$$signature : "I;"} );
			egl.atLine(this.eze$$fileName,102,2836,91, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setText": function( text ) {
		...
		try { egl.enter("setText",this,arguments,eze$$updater);
			egl.addLocalFunctionVariable("text", text, "string", "text");
			egl.atLine(this.eze$$fileName,108,2974,28, this);
			this.setAttribute("value", {eze$$value : text, eze$$signature : "S;"} );
			egl.atLine(this.eze$$fileName,107,2931,78, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getText": function() {
		...
		try { egl.enter("getText",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,112,3059,41, this);
			var ezert$$9 = null;
			ezert$$9 = ezert$$8;
	...
	"getReadOnly": function() {
		...
		try { egl.enter("getReadOnly",this,arguments,eze$$updater);
			var $result = false;
			egl.atLine(this.eze$$fileName,116,3159,17, this);
	...
	"setReadOnly": function( ro ) {
		...
		try { egl.enter("setReadOnly",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,120,3230,14, this);
			this.readOnly = ro;
			egl.atLine(this.eze$$fileName,121,3247,271, this);
			if ( ro ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,122,3257,33, this);
					this.setAttribute("readOnly", {eze$$value : "true", eze$$signature : "S;"} );
					egl.atLine(this.eze$$fileName,123,3294,39, this);
					this.savedBackgroundColor = this.getBackgroundColor();
					egl.atLine(this.eze$$fileName,124,3337,23, this);
					this.setBackgroundColor(String('',null));
					egl.atLine(this.eze$$fileName,125,3364,33, this);
					this.setClass("EglRuiTextAreaReadOnly");
				}finally{egl.exitBlock();}
			}
			else {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,127,3408,28, this);
					this.removeAttribute("readOnly" );
					egl.atLine(this.eze$$fileName,128,3440,39, this);
					this.setBackgroundColor(this.savedBackgroundColor);
					egl.atLine(this.eze$$fileName,129,3483,29, this);
					this.setClass("EglRuiTextAreaRead");
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,119,3184,339, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
