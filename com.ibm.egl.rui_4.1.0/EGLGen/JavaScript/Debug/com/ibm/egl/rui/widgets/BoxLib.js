<!-- Generated at Fri Jan 25 15:06:28 CST 2013 by EGL 7.1.1.qualifier -->
...
egl.defineRUILibrary( 'com.ibm.egl.rui.widgets', 'BoxLib',
	{
		'eze$$fileName': '/com.ibm.egl.rui_4.1.0/EGLSource/com/ibm/egl/rui/widgets/BoxLib.egl',
		...
		"constructor" : function()
		{
			...
			try { egl.enter("<init>",this,arguments,eze$$updater);
				...
				egl.atLine(this.eze$$fileName,14,344,11, this);
				this.ALIGN_RIGHT = 2;
				egl.atLine(this.eze$$fileName,15,372,10, this);
				this.ALIGN_LEFT = 0;
				egl.atLine(this.eze$$fileName,16,400,12, this);
				this.ALIGN_CENTER = 1;
				if (!egl.debugg) egl.leave();
			} finally {
				if (!egl.debugg){
