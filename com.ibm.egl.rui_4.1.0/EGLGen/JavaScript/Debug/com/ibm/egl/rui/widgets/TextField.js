...
egl.defineRUIWidget('com.ibm.egl.rui.widgets', 'TextField', {
	'eze$$fileName': '/com.ibm.egl.rui_4.1.0/EGLSource/com/ibm/egl/rui/widgets/TextField.egl',
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,62,2166,48, this);
			this.maxLength = 0;
			egl.atLine(this.eze$$fileName,63,2216,85, this);
			this.text = "";
			egl.atLine(this.eze$$fileName,64,2303,94, this);
			this.readOnly = false;
			egl.atLine(this.eze$$fileName,65,2399,22, this);
			this.error = false;
			egl.atLine(this.eze$$fileName,67,2425,37, this);
			this.savedEnableSelection = false;
			egl.atLine(this.eze$$fileName,68,2464,36, this);
			this.savedBackgroundColor = "";
			this.jsrt$SysVar= new egl.egl.core.SysVar();
			new egl.egl.ui.rui.RUILib();
			egl.atLine(this.eze$$fileName,65,2399,5, this);
			this.error = false;
	...
	"start": function() {
		...
		try { egl.enter("start",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,71,2522,34, this);
			...
			egl.atLine(this.eze$$fileName,72,2559,33, this);
			...
			egl.atLine(this.eze$$fileName,70,2503,94, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"enableSelection": function( e ) {
		...
		try { egl.enter("enableSelection",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,76,2671,32, this);
			var ezert$$1 = false;
			ezert$$1 = egl.egl.ui.rui.RUILib['$inst'].getTextSelectionEnabled();
			egl.atLine(this.eze$$fileName,76,2648,56, this);
			this.savedEnableSelection = ezert$$1;
			egl.atLine(this.eze$$fileName,77,2707,37, this);
			egl.egl.ui.rui.RUILib['$inst'].setTextSelectionEnabled(true );
			egl.atLine(this.eze$$fileName,75,2601,148, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"disableSelection": function( e ) {
		...
		try { egl.enter("disableSelection",this,arguments,eze$$updater);
			egl.addLocalFunctionVariable("e", e, "egl.ui.rui.Event", "e");
			egl.atLine(this.eze$$fileName,81,2801,53, this);
			egl.egl.ui.rui.RUILib['$inst'].setTextSelectionEnabled(this.savedEnableSelection );
			egl.atLine(this.eze$$fileName,80,2753,106, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getReadOnly": function() {
		...
		try { egl.enter("getReadOnly",this,arguments,eze$$updater);
			var $result = false;
			egl.atLine(this.eze$$fileName,85,2914,17, this);
	...
	"setReadOnly": function( ro ) {
		...
		try { egl.enter("setReadOnly",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,89,2986,14, this);
			this.readOnly = ro;
			egl.atLine(this.eze$$fileName,90,3003,275, this);
			if ( this.readOnly ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,91,3019,33, this);
					this.setAttribute("readOnly", {eze$$value : "true", eze$$signature : "S;"} );
					egl.atLine(this.eze$$fileName,92,3056,39, this);
					this.savedBackgroundColor = this.getBackgroundColor();
					egl.atLine(this.eze$$fileName,93,3099,23, this);
					this.setBackgroundColor(String('',null));
					egl.atLine(this.eze$$fileName,94,3126,34, this);
					this.setClass("EglRuiTextFieldReadOnly");
				}finally{egl.exitBlock();}
			}
			else {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,96,3171,28, this);
					this.removeAttribute("readOnly" );
					egl.atLine(this.eze$$fileName,97,3203,39, this);
					this.setBackgroundColor(this.savedBackgroundColor);
					egl.atLine(this.eze$$fileName,98,3246,26, this);
					this.setClass("EglRuiTextField");
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,88,2940,343, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setText": function( text ) {
		...
		try { egl.enter("setText",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,103,3329,28, this);
			this.setAttribute("value", {eze$$value : text, eze$$signature : "S;"} );
			egl.atLine(this.eze$$fileName,102,3286,76, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getText": function() {
		...
		try { egl.enter("getText",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,107,3412,43, this);
			var ezert$$3 = null;
			ezert$$3 = ezert$$2;
	...
	"getMaxLength": function() {
		...
		try { egl.enter("getMaxLength",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,111,3512,42, this);
			var ezert$$5 = null;
			ezert$$5 = ezert$$4;
	...
	"setMaxLength": function( maxLength ) {
		...
		try { egl.enter("setMaxLength",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,115,3613,47, this);
			this.setAttribute("maxLength", {eze$$value : (maxLength).toString(), eze$$signature : "S;"} );
			egl.atLine(this.eze$$fileName,114,3563,102, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
